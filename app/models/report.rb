...
class Report < ActiveRecord::Base
  ...
  scope :filter_by, -> (params) { select(:id, :reported_at, :work_hour).includes(:tasks).where(project_id: params[:project_id], reported_at: params[:start_date]..params[:end_date]).group("reports.id").order("reports.reported_at ASC")}
  ##
